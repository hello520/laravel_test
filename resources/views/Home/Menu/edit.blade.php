        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                ...
                <div class="block">
                    ...
                    <form id="form-validation" action="{{asset('menu/')}}" method="post" class="form-horizontal form-bordered">
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="val-username">名称 <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val-username" name="name" class="form-control" placeholder="名称" value="{{$menu_info->name}}">
                            </div>
                        </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <select id="example-chosen" name="parent_id" class="select-chosen" data-placeholder="选择菜单" style="width: 250px;">
                                        ...
                                        @foreach ($menus as $menu)
                                            <option value="{{$menu->id}}" @if($menu->id == $menu_info->parent_id) selected="" @endif>
                                                {{$menu->name}}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="val-email" name="mark" class="form-control" placeholder="链接地址标识" value="{{$menu_info->mark}}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="url" class="form-control" placeholder="链接地址" value="{{$menu_info->url}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="val-suggestions">描述 <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <textarea id="val-suggestions" name="des" rows="7" class="form-control" placeholder="描述">{{$menu_info->des}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <label class="switch switch-primary" for="val-terms">
                                    <input type="checkbox" @if($menu_info->status) checked="checked" @endif  id="val-terms" name="status" value="1">
                        ...
                        <div class="form-group form-actions">
                            <div class="col-md-8 col-md-offset-3">
                                ...
                                <a href="javascript:history.go(-1)" type="reset" class="btn btn-effect-ripple btn-danger">返回</a>
                            </div>
                        </div>
                    </form>
